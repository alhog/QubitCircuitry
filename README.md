...
3. [Implementation](#implementation)
    - [Unified Oracle Contracts](#quasi-oracle-contracts)
    - [Unified Token Contracts](#quasi-token-contracts)
    - [Resilient Identity Systems](#resilient-identity-systems)
    - [Verified Voting Systems](#verified-voting-systems)
